...
const OverHeadView = props => {
    const {  playerObj, mazeGrid, collectables, otherPlayers } = props;
    ...
    return (
        <>
            ...
            <div><div style={{float: "left", paddingTop: "150px"}}>WEST ({MAP.WEST})</div><div style={{float: "left"}}>{MAP.displayMazeGrid(mazeGrid, playerObj, collectables, otherPlayers)}</div><div style={{float: "left", paddingTop: "150px"}}>EAST ({MAP.EAST})</div></div>
